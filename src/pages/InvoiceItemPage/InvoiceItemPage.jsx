...
import {useInvoiceItemDetailsQuery} from '../../services/invoiceDeleteApi'
        ...
        <div className="ml-[15rem] mr-[17rem] my-9">
          ...
          <div className="w-full h-[5.5] flex items-center justify-between bg-white text-body-1 rounded-[8px] py-3 mt-3">
            <div className="flex items-center text-xs">
              ...
              <span
                className={`flex flex-col justify-center ml-5 rounded-[6px] font-bold py-3 px-5  
    `}
              >
                <span className=" relative">
                  <span
                    className={`absolute w-2 h-2 top-[3px]
    rounded-full`}
                  ></span>
